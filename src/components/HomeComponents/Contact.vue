  ...
  <div class="bg-[#18294C]" id="contact">
    ...
    <div class="flex justify-center">
      <h1 class="text-white text-base sm:text-lg md:text-xl mt-5 px-4 text-center">
        نسعد بتواصلكم بالمدرسه في اي وقت
      </h1>
    </div>
    <div class="flex justify-center">
        ...
        <div class="bg-[#F5EFE5] p-6 md:p-8 rounded-3xl shadow flex flex-col gap-6">
          ...
          <div class="flex items-start gap-3">
            <div class="bg-[#D4AB34] p-3 rounded-full text-pink-700">
              <svg
                ...
                class="w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 lg:w-10 lg:h-10 shrink-0"
                width="40"
                height="40"
                viewBox="0 0 24 24"
              >
          ...
          <div class="flex flex-col justify-center gap-4 mt-4">
            ...
            >
              ...
              <h1 class="text-lg sm:text-xl md:text-2xl lg:text-3xl mr-3">فيسبوك</h1>
            </a>
            ...
            >
              ...
              <h1 class="text-lg sm:text-xl md:text-2xl lg:text-3xl mr-3">يوتيوب</h1>
            </a>
          </div>
        </div>
      </div>
