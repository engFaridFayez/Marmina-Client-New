        ...
        <div class="flex">
          <div class="text-red-500 p-2 sm:p-3 shrink-0">
            ...
            >
              ...
              <path fill="currentColor" d="M0 0h24v24H0z" mask="url(#SVGG1he6d3K)" />
              <g
                fill="none"
                stroke="currentColor"
                stroke-dasharray="20"
        ...
        <div class="flex">
          <div class="text-green-500 p-2 sm:p-3 shrink-0">
            ...
            >
              <defs>
                <mask id="SVG9LXuEA4n">
                  <g
                    ...
                    stroke-linejoin="round"
                  >
                    <path stroke="#fff" stroke-width="2" d="M2 13.5l4 4l10.75 -10.75">
                      <animate
                        fill="freeze"
                        attributeName="stroke-dashoffset"
                        dur="0.5s"
              ...
              <path fill="currentColor" d="M0 0h24v24H0z" mask="url(#SVG9LXuEA4n)" />
              <path
                fill="none"
                stroke="currentColor"
                stroke-dasharray="24"
