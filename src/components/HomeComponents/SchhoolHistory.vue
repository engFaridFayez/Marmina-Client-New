...
<template>
  <div class="bg-[#18294A]">
    ...
    <div class="flex flex-col items-center pt-5 px-4">
      <h1 class="text-[#D4AB34] text-2xl font-bold md:text-4xl pb-10 text-center">
        الاباء الذين خدموا المدرسة
      </h1>

      <div class="bg-[#2E405C] mb-15 w-full md:w-[90%] lg:w-[80%] p-6 md:p-10 rounded-3xl">
        <!-- grid -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-white">
          <!-- عنصر -->
          <div class="text-center">
            <h1 class="text-xl md:text-2xl font-bold mb-2 text-yellow-400">
              القمص مينا ظريف (1965 - 1985)
            </h1>
            <p class="text-base md:text-lg leading-relaxed">الاب المؤسس والراعي الاول للمدرسة</p>
          </div>

          <!-- عنصر -->
          <div class="text-center">
            <h1 class="text-xl md:text-2xl font-bold mb-2 text-yellow-400">
              القمص افرام سعد (1985 - 2005)
            </h1>
            <p class="text-base md:text-lg leading-relaxed">قائد مرحلة التوسع والنمو</p>
          </div>

          <!-- عنصر -->
          <div class="text-center">
            <h1 class="text-xl md:text-2xl font-bold mb-2 text-yellow-400">
              القمص ارسانيوس نصيف (2005 - حتي الان)
            </h1>
            <p class="text-base md:text-lg leading-relaxed">راعي اخر للمدرسه</p>
          </div>
        </div>
      </div>
    </div>
